...
router.get('/', optionalAuth, async (req, res) => {
  const { category, featured, search, sort = 'display_order', order = 'ASC', limit = 20, offset = 0 } = req.query;
...
router.post('/', [authenticateToken, isAdmin], async (req, res) => {
  let {
    ...
    stock_quantity, sku, material, weight, is_featured, display_order
  } = req.body;
  ...
  try {
    ...
    `, [
      ...
      weight || null, is_featured ? 1 : 0, display_order
    ]);
...
router.put('/:id', [authenticateToken, isAdmin], async (req, res) => {
  let {
    category_id, name, slug, description, price, discount_price,
    stock_quantity, sku, material, weight, is_featured, is_active, display_order
  } = req.body;
